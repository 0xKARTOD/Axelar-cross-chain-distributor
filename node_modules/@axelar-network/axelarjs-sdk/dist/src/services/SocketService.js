    ...
    joinRoomAndWaitForEvent(roomId, sourceChain, destinationChain, destinationAddress) {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.socket.on("bridge-event", (data) => {
                ...
                const sourceChainConfig = this.supportedChains.find((chain) => chain.chainName.toLowerCase() === sourceChain.toLowerCase());
                const destChainConfig = this.supportedChains.find((chain) => chain.chainName.toLowerCase() === destinationChain.toLowerCase());
