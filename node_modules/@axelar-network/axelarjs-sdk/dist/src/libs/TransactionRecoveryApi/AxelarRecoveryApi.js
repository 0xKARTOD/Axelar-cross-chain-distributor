...
(function (GMPStatus) {
    ...
    GMPStatus["DEST_EXECUTE_ERROR"] = "destination_execute_error";
...
class AxelarRecoveryApi {
    ...
    fetchGMPTransaction(txHash, txLogIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.execGet(this.axelarGMPApiUrl, {
                method: "searchGMP",
                txHash,
                txLogIndex,
            })
    ...
    parseGMPStatus(response, txHash) {
    ...
    getChainInfo(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!chainInfo)
                throw new Error("cannot find chain" + chain);
            return chainInfo;
        });
    }
    confirmGatewayTx(txHash, chain) {
        return __awaiter(this, void 0, void 0, function* () {
            const { module, chainIdentifier } = yield this.getChainInfo(chain);
    ...
    queryBatchedCommands(chain, batchCommandId = "") {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    queryGatewayAddress({ chain }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.axelarQuerySvc)
                this.axelarQuerySvc = yield AxelarQueryClient_1.AxelarQueryClient.initOrGetAxelarQueryClient(this.config);
            return yield this.axelarQuerySvc.evm.GatewayAddress({ chain });
        });
    }
    ...
    sendApproveTx(chain, data, evmWalletDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const txRequest = evmClient.buildUnsignedTx(gatewayInfo.address, { data });
            return yield this.execRecoveryUrlFetch("/send_evm_tx", {
                chain,
                gatewayAddress: gatewayInfo.address,
                txRequest,
            });
    ...
    broadcastEvmTx(chain, data, evmWalletDetails = { useWindowEthereum: true }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield evmClient.broadcastToGateway(gatewayInfo.address, { data });
        });
    }
    execRecoveryUrlFetch(endpoint, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.execPost(this.recoveryApiUrl, endpoint, params);
        });
    }
    execPost(base, endpoint, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, cross_fetch_1.default)(base + endpoint, {
                method: "POST",
    ...
    execGet(base, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, cross_fetch_1.default)(base + "?" + new URLSearchParams(params).toString(), {
                method: "GET",
                headers: { "Content-Type": "application/json" },
                cache: "no-store",
            })
