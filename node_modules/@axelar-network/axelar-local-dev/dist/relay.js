...
var _a = ethers_1.ethers.utils, defaultAbiCoder = _a.defaultAbiCoder, arrayify = _a.arrayify;
...
var executeCommands = function (to, commands) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = arrayify(defaultAbiCoder.encode(['uint256', 'bytes32[]', 'string[]', 'bytes[]'], [to.chainId, commands.map(function (com) { return com.commandId; }), commands.map(function (com) { return com.name; }), commands.map(function (com) { return com.encodedData; })]));
